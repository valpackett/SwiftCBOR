...
class CBOREncoderTests: XCTestCase {
    ...
    func testEncodeDates() {
        ...
        let dateAsMap = Date(timeIntervalSince1970: 1363896240.5)
        XCTAssertEqual(
            CBOR.encodeDate(dateAsMap, options: CBOROptions(dateStrategy: .annotatedMap)),
            [0xa2, 0x66, 0x5f, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x74, 0x64, 0x61, 0x74, 0x65, 0x5f, 0x65, 0x70, 0x6f, 0x63, 0x68, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x67, 0x5f, 0x5f, 0x76, 0x61, 0x6c, 0x75, 0x65, 0xfb, 0x41, 0xd4, 0x52, 0xd9, 0xec, 0x20, 0x00, 0x00]
        )

        let oldDateAsMap = Date(timeIntervalSince1970: -156896240.5)
        XCTAssertEqual(
            CBOR.encodeDate(oldDateAsMap, options: CBOROptions(dateStrategy: .annotatedMap)),
            [0xa2, 0x66, 0x5f, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x74, 0x64, 0x61, 0x74, 0x65, 0x5f, 0x65, 0x70, 0x6f, 0x63, 0x68, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x67, 0x5f, 0x5f, 0x76, 0x61, 0x6c, 0x75, 0x65, 0xfb, 0xc1, 0xa2, 0xb4, 0x17, 0xe1, 0x00, 0x00, 0x00]
        )
    }
